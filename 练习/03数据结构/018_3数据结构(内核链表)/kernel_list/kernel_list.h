...
/**
* list_add_tail – add a new entry 将节点添加到链表末尾
* @new: new entry to be added
...
/**
* list_del – deletes entry from list. 实现仅仅是将节点从链表中取下
...
/**
* list_splice – join two lists  两个链表拼接
...
/**
* list_entry – get the struct for this entry 返回值为大结构体地址
...
/**
* list_for_each_entry    -    iterate over list of given type  遍历返回大结构体
